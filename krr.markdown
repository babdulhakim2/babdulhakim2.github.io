...
<div class="module-container">
  <div class="module-sidebar">
    {% include module-navigation.html units=site.data.krr_units module_title="Knowledge Representation and Reasoning" %}
  </div>
  
  <div class="module-content">
    <div class="welcome-banner">
      <h2>Knowledge Representation and Reasoning Module</h2>
      <p>This section contains all my work for the Knowledge Representation and Reasoning module from April 2025. The module explores fundamental concepts in knowledge representation, logic programming, ontology development, and reasoning techniques with practical applications in artificial intelligence.</p>
    </div>
    
    {% for unit in site.data.krr_units %}
